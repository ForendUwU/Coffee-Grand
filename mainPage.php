    ...
    <body>
        ...
        <div id="r">
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-8 col-lg-offset-2">
                        <h4>Подарок именинникам!</h4>
                        <p>Перейдите на вкладку меню, зарегистрируйтесь и получите бонусные баллы в свой день рождения, которые вы сможете потратить, чтобы получить кофе абсолютно бесплатно!</p>
                    </div>
                </div>
            </div>
        </div>
